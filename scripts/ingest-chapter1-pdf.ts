...
/**
 * Chapter I PDF Ingestion
 *
 * Reads Chapter I from PDF, chunks it, generates embeddings, and stores in Supabase.
 * This replaces the "ghost data" that was scraped from the AmLegal SPA.
 */
...
function cleanPDFText(text: string): string {
  ...
  cleaned = cleaned.replace(/^CHAPTER I\s+GENERAL PROVISIONS.*$/gm, '');
  cleaned = cleaned.replace(/^GENERAL PROVISIONS AND ZONING.*$/gm, '');
...
async function main() {
  ...
  console.log('CHAPTER I PDF INGESTION');
  console.log('='.repeat(80));
  console.log();
  ...
  console.log();
  console.log('='.repeat(80));
  console.log('✓ CHAPTER I PDF INGESTION COMPLETE');
  console.log('='.repeat(80));
  console.log();
  console.log('Summary:');
