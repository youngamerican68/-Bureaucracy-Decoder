...
/**
 * Ingest Chapter I Zoning Code into Supabase
 *
 * This script:
 * 1. Loads scraped Chapter I data
 * 2. Chunks the content using stateful parser (supports SEC. 12.XX format)
...
const SCRAPED_FILE = path.join(__dirname, '../.cache/la-zoning-scraped.json');
const DOC_SLUG = 'los-angeles-chapter1';
const CITY_NAME = 'Los Angeles';
const CODE_NAME = 'Chapter I - General Provisions and Zoning';
const SOURCE_URL = 'https://codelibrary.amlegal.com/codes/los_angeles/latest/lamc/0-0-0-107408';
...
function splitOversizedChunk(chunk: RegulationChunk): ProcessedChunk[] {
  ...
  // Attempt to split by subsections (e.g., 12.04.1, 12.04.2)
...
async function main() {
  ...
  console.log('CHAPTER I ZONING CODE INGESTION');
  console.log('='.repeat(80));
  console.log();
